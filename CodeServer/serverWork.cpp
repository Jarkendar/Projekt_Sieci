...
//WCZYTANIE DANYCH OD KLIENTA                    	
                      ...
                      int actualByte = 100;
                        ...
                        cout<<"Zawartosc kompresowanego bufora "<<endl;
...
//KOMPRESJA
					    ...
					    int x =compress2((Bytef *)compressFileBuffer,&lenghtAfterCompress,
					    (const  Bytef*)bufferToFile,fileSize,Z_BEST_COMPRESSION);
                                            
                                            
                                        
                                            cout<<"Status kompresji : "<<x<<endl;
                                          cout<<endl<<"dlugosc po kompresji "<<lenghtAfterCompress<<endl;
